...
with open('dpsgd_small_lr_result_1DPSGD_IBout_r0_n2.csv') as csv_file:
    #### alpha = 0.005
...
with open('dpsgd_small_lr_result_2DPSGD_IBout_r0_n2.csv') as csv_file:
    #### alpha = 0.01
    csv_reader = csv.reader(csv_file, delimiter=',')
    line_count = 0
    # skip the first four lines indicating the state of current program
...
with open('dpsgd_small_lr_result_3DPSGD_IBout_r0_n2.csv') as csv_file:
    #### alpha = 0.02
    csv_reader = csv.reader(csv_file, delimiter=',')
    line_count = 0
    # skip the first four lines indicating the state of current program
...
with open('dpsgd_small_lr_result_4DPSGD_IBout_r0_n2.csv') as csv_file:
    #### alpha = 0.04
    csv_reader = csv.reader(csv_file, delimiter=',')
    line_count = 0
    # skip the first four lines indicating the state of current program
...
with open('dpsgd_small_lr_result_5DPSGD_IBout_r0_n2.csv') as csv_file:
    #### alpha = 0.045
...
with open('dpsgd_small_lr_result_6DPSGD_IBout_r0_n2.csv') as csv_file:
    ### alpha = 0.08
    csv_reader = csv.reader(csv_file, delimiter=',')
    line_count = 0
    # skip the first four lines indicating the state of current program
...
ax = plt.axes()  
x = [int(i['epoch']) for i in val_record_1[2:]]
y1 = [float(i[interest]) for i in val_record_1[2:]]
y2 = [float(i[interest]) for i in val_record_2[2:]]
y3 = [float(i[interest]) for i in val_record_3[2:]]
y4 = [float(i[interest]) for i in val_record_4]
# y5 = [float(i[interest]) for i in val_record_5]
y6 = [float(i[interest]) for i in val_record_6]
...
plt.savefig('dpsgd_prec5.eps', format='eps')