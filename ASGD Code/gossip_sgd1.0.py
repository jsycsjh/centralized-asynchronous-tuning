...
def parse_args():
    ...
    print(ClusterManager.CHECKPOINT_DIR, args.tag, args.rank, args.world_size)
    args.out_fname = ClusterManager.CHECKPOINT_DIR + args.tag + 'out_r' + str(args.rank) + '_n' + str(args.world_size) + '.csv'
